...
<head>
    ...
    <title>Home - Personalized Academic Planner PAP</title>
            ...
            <div class="mid-section">
                ...
                <div class="classes-section">
                    ...
                    <ul class="classesList">
                        <li>
                            <div class="classDiv">
                                <input type="text" class="classValue" id="class-1" disabled value="ENSE 374" />
                                <button class="editSaveBtn">Edit</button>
                                <button class="delBtn">Delete</button>
                            </div>
                        </li>
                ...
                <div class="years-section">
                    ...
                    <ul class="yearsList">
                        <li>
                            <div class="yearDiv">
                                <input type="text" class="yearValue" id="year-1" disabled value="2023" />
                                <button class="editSaveBtn">Edit</button>
                                <button class="delBtn">Delete</button>
                            </div>
                        </li>
